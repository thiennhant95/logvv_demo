                ...
                <tr>
                    <td>
                        ...
                        <table width="100%" border="0">
                            <tr>
                                <td align="left" valign="bottom" colspan="3"><span class="style2"><strong>PAGEVIEWS：</strong><?php echo count($fetch);?><br><!--<strong>ユニークPV：</strong><?php //echo count($fetch_u);?><br>--><strong>UNIQUE VISITORS :</strong><?php echo count($fetch_uu);?></span></td>
                                <!--<td>&nbsp;</td>-->
                            </tr>
                            <tr style="margin-top:10px;">

                                <td width="33%" valign="top"><span class="style2"><strong>BY DAY：</strong></span>
                                    <?php
                                    $fetch_max = 0;
...
<!--                                                    <img src="images/bar_u.gif" width="--><?//=($width_u - $width_uu)*0.8;?><!--" height="8" align="left">-->
                                ...
                                <?php
                                    ...
                                    <table>
                                        <?php for($i=0;$i<=23;$i++):?>
                                            <tr>
                                                <td width="40" class="style1" style="margin:0px;padding:0px;">&nbsp;<?php echo $i;?>&nbsp;Hours</td>
...
<!--                                                    <img style="padding-top: 4px" src="images/bar_u.gif" width="--><?php //echo ($width_u - $width_uu)*0.8;?><!--" height="8" align="left">-->
                                ...
                                <td rowspan="2" width="33%" valign="top"><span class="style2"><strong>BY WEEKDAY：</strong></span>
                                    ...
                                    <br>
                                    <br>
                                    <span class="style2"><strong>TOP 5 SEARCHING ENGINE</strong></span><br>
                                    <?php for($i=0;$i<count($fetchENGINE);$i++):?>
                                        <?php echo ($i + 1);?>：<?php echo $fetchENGINE[$i]['ENGINE'];?>（<?php echo $fetchENGINE[$i]['CNT'];?> times）<br>
                                    <?php endfor;?>
                                    <br>
                                    <br>
<!--                                    <span class="style2"><strong>TOP 10 TỪ KHÓA</strong></span><br><br>-->
<!--                                    --><?php //for($i=0;$i<count($fetchQuery);$i++):?>
<!--                                        --><?php //echo ($i + 1);?><!--：--><?php //echo $fetchQuery[$i]['QUERY_STRING'];?><!--（--><?php //echo $fetchQuery[$i]['CNT'];?><!-- times）<br>-->
<!--                                    --><?php //endfor;?>
<!--                                    <br>-->
                                    <span class="style2"><strong>TOP 3 BROWSERS</strong></span><br>
                                    <?php for($i=0;$i<count($fetch_bro);$i++):?>
                                        <?php echo ($i + 1);?>：<?php echo $fetch_bro[$i]['BROWSER'];?>（<?php echo $fetch_bro[$i]['CNT'];?> times）<br>
                                    <?php endfor;?>
                                    <br>
                                    <br>
                                    <span class="style2"><strong>TOP 3 OPERATING SYSTEM</strong></span><br>
                                    <?php for($i=0;$i<count($fetch_os);$i++):?>
                                        <?php echo ($i + 1);?>：<?php echo $fetch_os[$i]['OS'];?>（<?php echo $fetch_os[$i]['CNT'];?> times）<br>
                                    <?php endfor;?>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <br>
                                    <span class="style2"><strong>TOP 3 MOST VIEWED PAGES</strong></span><br>
                                    <?php for($i=0;$i<count($fetchURL_b);$i++):?>
                                        <?php echo ($i + 1);?>：<?php echo $fetchURL_b[$i]['PAGE_URL'];?>（<?php echo $fetchURL_b[$i]['CNT'];?> times）<br>
                                    <?php endfor;?>
                                    <br>
                                    <br>
                                    <span class="style2"><strong>3 LEAST VIEWED PAGES</strong></span><br>
                                    <?php for($i=0;$i<count($fetchURL_w);$i++):?>
                                        <?php echo ($i + 1);?>：<?php echo $fetchURL_w[$i]['PAGE_URL'];?>（<?php echo $fetchURL_w[$i]['CNT'];?> times）<br>
                                    <?php endfor;?>
                                </td>
                            </tr>
                ...
                <tr>
                    <td>
                        <br>
                        <span class="style2"><strong>TOP 3 REFERRERS:</strong></span><br>
                        <?php for($i=0;$i<count($fetch_ref);$i++):?>
                            <?php echo ($i + 1);?>：<?php echo $fetch_ref[$i]['REFERER'];?>（<?php echo $fetch_ref[$i]['CNT'];?> times）<br>
                        <?php endfor;?>
                    </td>
                </tr>
            </table>
            ...
            &nbsp;&nbsp;           <b><a href="https://vietvang.net" target="_blank">VIET VANG JSC</a></b><br>
             7 Tran Xuân Haa, District 5, Ho Chi Minh City<br>
            Website: <a href="https://vietvang.net" target="_blank">vietvang.net </a><br>
